                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12 col-md-3 bg-success  text-center">
                            <a href="addlocation.php"><span class="mt-1 bg-success btn fs-5"> <i class="fa fa-user-plus "></i> Add location </span></a> 
                        </div>
                    </div>        
                </div>
                <div class="container-fluid">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="Addlocation.php?id=<?php echo $row['id']?>"><i class="fa fa-edit" style="font-size:20px"></i></a>
                              
                                    <a href="del.php?id=<?php echo $row['id']?>" onclick="return confirm('user delete')"><i class='fas fa-trash-alt text-danger' style='font-size:20px'></i></a>
                                </td>
                            </tr>
